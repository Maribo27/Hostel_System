...
public class UserUnlocking implements Command {
	private static final Logger logger = Logger.getLogger(UserUnlocking.class);

	/**
	 * The method changes the status of the selected user to "user".
