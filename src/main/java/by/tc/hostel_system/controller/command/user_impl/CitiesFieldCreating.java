...
public class CitiesFieldCreating implements Command {
	private static final Logger logger = Logger.getLogger(CitiesFieldCreating.class);
	private static final String CITIES = "cities";

	/**
	 * The method searches for cities.
